...
var aircraft = [
    ...
    {
        "id": "876b428a-3ee2-46cd-9d8c-2c59424dfcb5",
        "name": "AC-130"
    },
    {
        "id": "710c84ae-6fdc-4c4a-ac3b-4031c3036e98",
    ...
    {
        "id": "6af2c9f8-abd8-4872-a9bc-4e79fd84fe77",
    ...
    {
        "id": "0d49ce9e-446a-4d12-b651-6983afdeeb40",
        "name": "Boeing 747-SCA"
    },
    {
    ...
    {
        "id": "7b6e1658-42ab-4fc3-81ec-706445346d46",
        "name": "C-130H"
    },
    {
        "id": "33d26fc7-ae7d-4c5d-9e0d-d6cba93d4913",
        "name": "C-130J"
    },
    {
        "id": "e0e1900e-0e63-4700-b508-5e2efe120ce5",
        "name": "C-130J-30"
    },
    {
        "id": "2b1249c8-11d8-4fa6-9aae-a99eff451225",
        "name": "C-17"
    },
    {
        "id": "ef677903-f8d3-414f-a190-233b2b855d46",
        "name": "Cessna 172"
    },
    {
        "id": "206884f9-38a8-4118-a920-a7dcbd166c47",
        "name": "Cessna 208"
    },
    {
        "id": "150fd3d1-1b06-431b-a889-628ae470d57b",
        "name": "Cessna Citation X"
    },
    {
        "id": "e92bc6db-a9e6-4137-a93c-a7423715b799",
        "name": "Cirrus SR22 GTS"
    },
    {
    ...
    {
        "id": "7bd8096f-8eae-47b9-8e1a-38dabd2c59c4",
        "name": "F-16"
    },
    {
        "id": "849366e1-cb11-4d72-9034-78b11cd026b0",
        "name": "F-22"
    },
    {
    ...
    {
        "id": "8a62f1d0-bca9-494c-bc01-1fb8b7255f76",
        "name": "Spitfire"
    },
    {
        "id": "3f17ca35-b384-4391-aa5e-5beececb0612",
        "name": "TBM-930"
    }
]
...
loginForm.addEventListener("submit", (e) => {
    ...
    $.ajax({
        ...
        data: '{"discourseNames": ["' + ifc + '"]}',
        success: function (data) {
            ifUserId = data.result[0].userId;
            download(ifUserId);
        },
    });
});
...
function download() {
    ...
    $.get("https://api.infiniteflight.com/public/v2/users/" + ifUserId + "/flights?apikey=rgqs3p8ewvkacjpb8hlh06jo7hyqrq9k", function (data) {
    })
        .done(function (data) {
            ...
            itemsNotFormatted = data.result.data;
            ...
            itemsNotFormatted.forEach((item) => {
                ...
                itemsFormatted.push({
                    ...
                    flightNumber: '',
                    from: item.originAirport,
                    to: item.destinationAirport,
                    depTime: '',
                    arrTime: '',
                    duration: minToH(item.totalTime),
                    airline: '',
                    aircraft: aircraftFullName,
                    registration: '',
                    seatNumber: '',
                    seatType: '',
                    flightClass: '',
            ...
            var fileTitle = 'flights'; // or 'my-unique-title'
